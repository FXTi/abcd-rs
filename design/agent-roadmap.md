...
| 3.10 | Construct 调用种类：CallKind::Construct + Newobjrange 正确往返（V3+V8-opt 共同根因，~108 fixture-runs） | worker P3-T10 (k3) | **进行中**（baseline：lift 575 / opt 636，orchestrator 实测） |
